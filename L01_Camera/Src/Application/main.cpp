...
void Application::Update()
{
	//キャラ制御
	{
		...
		//動くけど危険
		//if (GetAsyncKeyState('W'))m_HamuWorld._43 += 0.1f ;
		//if (GetAsyncKeyState('S'))m_HamuWorld._43 -= 0.1f ;
		//if (GetAsyncKeyState('A'))m_HamuWorld._41 -= 0.1f ;
		//if (GetAsyncKeyState('D'))m_HamuWorld._41 += 0.1f ;
		...
		//{
		//	speed += 1.0f;
		//	m_HamuWorld *= Math::Matrix::CreateTranslation(0.0f, 0.0f, speed);
		//}
		...
		//{
		//	speed -= 1.0f;
		//	m_HamuWorld *= Math::Matrix::CreateTranslation(speed, 0.0f,0.0f );
		//}
